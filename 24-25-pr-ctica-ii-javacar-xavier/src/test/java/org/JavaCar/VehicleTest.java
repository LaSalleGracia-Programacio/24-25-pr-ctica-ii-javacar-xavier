...
public class VehicleTest {
    ...
    public void testNoEsPotInstanciarVehicle() throws Exception {
        try {
            ...
            clazz.getDeclaredConstructor().newInstance(); // Això hauria de llençar una excepció
            fail("S'esperava una excepció perquè Vehicle és abstracta");
        } catch (InvocationTargetException | NoSuchMethodException e) {
            throw new InstantiationException("No es pot instanciar una classe abstracta");
        }
    }
